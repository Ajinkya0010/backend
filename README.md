...
Cloud Function)
you must attach your Workload SA (workload@hack-team-ashoka.iam.gserviceaccount.com) , usually referred to in the GCP documentation as "attaching a custom
SA".
...
* [Vertex AI](https://cloud.google.com/vertex-ai/docs/general/custom-service-account#attach)
    * Vertex AI's Console UI does not always expose the field necessary to specify a user managed SA.  
      ...
      (typically `"serviceAccount": "workload@hack-team-ashoka.iam.gserviceaccount.com"`, to be added as a peer of the `"name": "..."`
