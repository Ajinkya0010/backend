# Welcome, ashoka, to the 2024 TDI Global Hackathon
## Contents
...
1. A GCP project (https://console.cloud.google.com/home/dashboard?project=hack-team-ashoka)
2. This GitHub repository (https://github.com/db-hackathon/ashoka)
3. A Terraform Cloud workspace (https://app.terraform.io/app/db-hackathon-2024/workspaces/hack-team-ashoka)
...
## [GCP](https://console.cloud.google.com/home/dashboard?project=hack-team-ashoka)
### First log-in
...
8. Navigate to https://console.cloud.google.com/home/dashboard?project=hack-team-ashoka.
...
You have an "infrastructure SA" (infrastructure@hack-team-ashoka.iam.gserviceaccount.com) with the same IAM permissions as team members.
...
You have a "workload SA" (workload@hack-team-ashoka.iam.gserviceaccount.com) that you can use to attach to your workloads (e.g. Cloud Run revisions).
...
you must attach your Workload SA (workload@hack-team-ashoka.iam.gserviceaccount.com) , usually referred to in the GCP documentation as "attaching a custom SA".
...
(typically `"serviceAccount": "workload@hack-team-ashoka.iam.gserviceaccount.com"`, to be added as a peer of the `"name": "..."` or `"displayName" : "..."` attribute) 
and execute the resulting command in Cloud Shell.

Here's an example for tuning a language model:
```shell
PROJECT_ID="hack-team-ashoka"

curl \
-X POST \
-H "Authorization: Bearer $(gcloud auth print-access-token)" \
-H "Content-Type: application/json; charset=utf-8" \
https://europe-west4-aiplatform.googleapis.com/v1/projects/hack-team-ashoka/locations/europe-west4/pipelineJobs?pipelineJobId=tune-large-model-$(date +"%Y%m%d%H%M%S") -d \
$'{
    "displayName": "tune-large-model",    
    "serviceAccount": "workload@hack-team-move.iam.gserviceaccount.com", 
    "runtimeConfig": {
        "gcsOutputDirectory": "gs://artifacts.hack-team-ashoka.appspot.com/Foo/",
        "parameterValues": {
            "location": "us-central1",
            "project": "hack-team-ashoka",
            "large_model_reference": "text-bison@001",
            "model_display_name": "mytunedmodel_1",
            "train_steps": 100,
            "encryption_spec_key_name": "",
            "dataset_uri": "gs://artifacts.hack-team-ashoka.appspot.com/Bar.jsonl",
            "evaluation_data_uri": "",
...
2. Configure your default Cloud Shell Google Cloud Project by running ```gcloud config set project hack-team-ashoka```

---
</br>

## [GitHub](https://github.com/db-hackathon/ashoka)
...
* vars.INFRA_SA_EMAIL - The email address representation of the SA you can use to deploy infrastructure. It has the same access rights as human team members.: infrastructure@hack-team-ashoka.iam.gserviceaccount.com
* vars.INFRA_SA_ID - The fully qualified ID representation of the SA you can use to deploy infrastructure.: projects/hack-team-ashoka/serviceAccounts/infrastructure@hack-team-ashoka.iam.gserviceaccount.com
* vars.PROJECT_ID - Your team's GCP Project ID.: hack-team-ashoka
* vars.PROJECT_NUMBER - Your teams' GCP Project Number.: 818016464490
...
* vars.WORKLOAD_SA_EMAIL - The email address representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : workload@hack-team-ashoka.iam.gserviceaccount.com
* vars.WORKLOAD_SA_ID - The fully qualified ID representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : projects/hack-team-ashoka/serviceAccounts/workload@hack-team-ashoka.iam.gserviceaccount.com
...
## [Terraform Cloud](https://app.terraform.io/app/db-hackathon-2024/workspaces/hack-team-ashoka)
...
* infra_sa_email - The email address representation of the SA you can use to deploy infrastructure. It has the same access rights as human team members.: infrastructure@hack-team-ashoka.iam.gserviceaccount.com
* infra_sa_id - The fully qualified ID representation of the SA you can use to deploy infrastructure.: projects/hack-team-ashoka/serviceAccounts/infrastructure@hack-team-ashoka.iam.gserviceaccount.com
* project_id - Your team's GCP Project ID.: hack-team-ashoka
* project_number - Your teams' GCP Project Number.: 818016464490
...
* workload_sa_email - The email address representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : workload@hack-team-ashoka.iam.gserviceaccount.com
* workload_sa_id - The fully qualified ID representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : projects/hack-team-ashoka/serviceAccounts/workload@hack-team-ashoka.iam.gserviceaccount.com
